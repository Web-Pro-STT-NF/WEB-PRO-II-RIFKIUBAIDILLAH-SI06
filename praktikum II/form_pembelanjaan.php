...
<div class="row" style="padding:10px">
    ...
    <form method="POST" action="form_belanja.php" >
        ...
        <div class="form-group row">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                ...
                <label for="produk_0" class="custom-control-label">Motor</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
  ...
  <tbody>
    <tr>
      <th scope="row">Motor : 13.120.000</th>
    </tr>
    <tr>
      <th scope="row">Handphone : 5.700.000</th>
    </tr>
    <tr>
      <th scope="row">Laptop   : 7.300.000</th>
    </tr>
  </tbody>
  <thead class="thead-dark">
    <tr>
